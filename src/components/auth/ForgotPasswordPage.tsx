              ...
              <form onSubmit={handleSubmit} novalidate class="flex flex-col gap-6">
                ...
                <div class="flex flex-col items-center text-center gap-4">
                  <div
                    ...
                    classList={{
                      'bg-destructive/10 dark:bg-destructive/20': hasError(),
                      'bg-primary/8 dark:bg-primary/15': !hasError(),
                    }}
                  >
                    <Lock
                  ...
                  <div class="flex flex-col gap-1.5">
                    <h2 class="text-foreground text-xl font-semibold">Forgot your password?</h2>
            ...
            <div class="flex flex-col items-center text-center gap-5 px-1">
              ...
              <div class="rounded-xl border border-border bg-muted/40 px-4 py-3 text-left w-full">
                <p class="text-muted-foreground text-[13px]">
                  <span class="font-medium text-foreground">Didn't receive it?</span> Check your spam folder
                  or wait a moment before requesting another link.
                </p>
              </div>
